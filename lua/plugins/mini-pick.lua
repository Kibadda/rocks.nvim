return {
  ...
  keys = {
    ...
    { "<Leader>F", "<Cmd>Pick files vcs=false<CR>", desc = "Find All Files" },
    { "<Leader>b", "<Cmd>Pick buffers<CR>", desc = "Find Buffer" },
    { "<Leader>h", "<Cmd>Pick hunks<CR>", desc = "Git Hunks (unstaged)" },
    { "<Leader>H", "<Cmd>Pick hunks unstaged=false<CR>", desc = "Git Hunks (staged)" },
    { "<Leader>t", "<Cmd>Pick stashes<CR>", desc = "Git Stashes" },
    ...
    { "<Leader>sb", "<Cmd>Pick buf_lines<CR>", desc = "Lines" },
